...
import com.framework.javaMailerAPI.EmailAttachmentsSender;

import javax.mail.MessagingException;

import static com.framework.constants.FrameworkConstants.YES;
import static com.framework.javaMailerAPI.EmailConfig.*;
...
class EmailSendUtils
{
    ...
    public static void sendEmail(int count_totalTCs, int count_passedTCs, int count_failedTCs, int count_skippedTCs) {
        System.out.println ("I'm in Send Email" );
