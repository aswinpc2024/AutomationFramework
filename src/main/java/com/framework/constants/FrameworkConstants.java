...
class FrameworkConstants {
    ...
    private static final Duration EXPLICIT_WAIT = Duration.ofSeconds(60);
...
//    public static final String Zipped_ExtentReports_Folder_Name = "ExtentReports.zip";
    ...
    private static final String Project_Name = "Automation Test Suite Report - Prosper - Sprint 19";
